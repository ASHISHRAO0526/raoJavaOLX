...
public class NewAdvertisementPostRequest {
	...
	double price;
	int statusId;
	public NewAdvertisementPostRequest(int id, String title, int categoryId, String description) {
		super();
		this.id = id;
		this.title = title;
	...
	public NewAdvertisementPostRequest(String title, int categoryId, String description) {
		super();
		this.title = title;
		this.categoryId = categoryId;
		this.description = description;
